...
export function AppPreviewSectionReversed() {
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          {/* Left Section - App Preview Card */}
          <motion.div
          ...
          >
            {/* Background Gradient */}
            <div className="absolute inset-0 bg-gradient-to-br from-blue-100/50 via-purple-50/30 to-pink-100/50 rounded-3xl blur-xl" />
            ...
            <div className="relative bg-white/60 backdrop-blur-sm border border-white/20 rounded-3xl p-8 shadow-2xl">
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-lg font-semibold text-gray-900">AllergySafe</h3>
              </div>
              ...
              <div className="relative bg-white rounded-2xl p-6 shadow-lg border border-gray-100 mb-6">
                <p className="text-sm text-gray-700 mb-4 leading-relaxed">
                  Build a comprehensive allergy management system with emergency contacts, medication tracking, and restaurant integration
                </p>
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="ml-auto bg-purple-500 hover:bg-purple-600 text-white p-2 rounded-lg transition-colors duration-200 shadow-md"
                  >
              ...
              <div className="space-y-4 opacity-60 blur-sm">
                <div className="flex items-center justify-between">
                  <h4 className="text-sm font-semibold text-gray-900">Emergency Kit</h4>
                ...
                <div className="pt-2">
                  <h5 className="text-sm font-medium text-gray-700 mb-2">Safety Tools</h5>
